...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:Panel ID="Panel1" runat="server" CssClass="modalpopup" height="500px" Width="600px">
            <div>
                <asp:Label ID="SampleTemplateLabel" runat="server" Text="Sample Template 1"></asp:Label>
            </div>
            <div class="imageCss">
                <asp:Image ID="ImageTemplate" runat="server" Height="400px" ImageUrl="~/WebTemplateImage/Template1.png" Width="500px" />
            </div>
            <div>
    ...
    <div>
        <asp:Panel ID="Panel2" runat="server" CssClass="modalpopup" height="500px" Width="600px">
            <div>
                <asp:Label ID="Label1" runat="server" Text="Sample Template 2"></asp:Label>
            </div>
            <div class="imageCss">
                <asp:Image ID="Image1" runat="server" Height="400px" ImageUrl="~/WebTemplateImage/Template2.png" Width="500px" />
            </div>
            <div>
    ...
    <div>
        <asp:Panel ID="Panel3" runat="server" CssClass="modalpopup"  height="500px" Width="600px">
            <div>
                <asp:Label ID="Label2" runat="server" Text="Sample Template 3"></asp:Label>
            </div>
            <div class="imageCss">
                <asp:Image ID="Image2" runat="server" Height="400px" ImageUrl="~/WebTemplateImage/Template3.png" Width="500px" />
            </div>
            <div>
    ...
    <div>
        <asp:Panel ID="Panel4" runat="server" CssClass="modalpopup"  height="500px" Width="600px">
            <div>
                <asp:Label ID="Label3" runat="server" Text="Sample Template 4"></asp:Label>
            </div>
            <div class="imageCss">
                <asp:Image ID="Image3" runat="server" Height="400px" ImageUrl="~/WebTemplateImage/Template4.png" Width="500px" />
            </div>
            <div>
    ...
    <div>
        <asp:Panel ID="Panel5" runat="server" CssClass="modalpopup" height="500px" Width="600px" >
            <div>
                <asp:Label ID="Label4" runat="server" Text="Sample Template52"></asp:Label>
            </div>
            <div class="imageCss">
                <asp:Image ID="Image4" runat="server" Height="400px" ImageUrl="~/WebTemplateImage/Template5.png" Width="500px" />
            </div>
            <div>
    ...
    <div>
        <asp:Panel ID="Panel6" runat="server" CssClass="modalpopup" height="500px" Width="600px">
            <div>
                <asp:Label ID="Label5" runat="server" Text="Sample Template6"></asp:Label>
            </div>
            <div class="imageCss">
                <asp:Image ID="Image5" runat="server" Height="400px" ImageUrl="~/WebTemplateImage/Template6.png" Width="500px" />
            </div>
            <div>
